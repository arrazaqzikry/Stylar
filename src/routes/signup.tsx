...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Stylar" },
      { name: "description", content: "Create your STYLAR personal atelier account." },
    ],
  }),
...
function SignUpPage() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden px-6 py-5">
      ...
      {/* Heading */}
      <div className="mb-5">
        <h1 className="font-display text-[1.6rem] leading-tight">Create account.</h1>
        <p className="text-[11px] text-muted-foreground mt-1">Start your style journey today.</p>
      </div>
      ...
      <form className="flex flex-col gap-3 flex-1" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="space-y-1">
          <label className="eyebrow text-[9px] text-muted-foreground block">Full Name</label>
          <input
            type="text"
            value={name}
        ...
        {/* Confirm Password */}
        <div className="space-y-1">
          <label className="eyebrow text-[9px] text-muted-foreground block">Confirm Password</label>
          <input
            type="password"
            value={confirmPass}
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="eyebrow text-[8px] text-muted-foreground">or sign up with</span>
          <span className="flex-1 h-px bg-border" />
        </div>
        ...
        <p className="text-center text-[11px] text-muted-foreground mt-auto pt-2">
          ...
          <Link to="/login" className="text-gold hover:opacity-70 transition-opacity">
            Log in
          </Link>
        </p>
      </form>
